...
if( isset($_POST['submit_data']) ){
	...
	$query = "INSERT INTO students (name, sector, marmol, cemento, piedra, madera, metalico, monocolor) VALUES ('$name', '$sector', '$marmol', '$cemento', '$piedra', '$madera', '$metalico', '$monocolor')";
...
<body> 
	...
	<form action="gracias.php" class="container" name="contact-form" action="" method="post" id="contact-form">
			<div class="col-12   text-center p-7">
				...
				<p class="font-size-lg text-center text-muted mb-0">Contesta las siguientes preguntas</p>


				<div class="form-label-group">
				    <input type="text" class="text-center form-control form-control-flush" id="cardName" placeholder="Sector" name="sector">
				    <label for="cardName">Sector</label>
				  </div>
			</div>
			<div class="row">
